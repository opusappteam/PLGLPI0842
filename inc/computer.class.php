...
/*
 * @version $Id: computer.class.php 20532 2013-03-29 08:01:35Z moyo $
  -------------------------------------------------------------------------
    ...
    function post_updateItem($history = 1) {
        ...
        for ($i = 0; $i < count($this->updates); $i++) {
            ...
            if ((($this->updates[$i] == "contact") || ($this->updates[$i] == "contact_num"))
                ...
                if ($update_done) {
                    Session::addMessageAfterRedirect(
                            __('Alternate username updated. The connected items have been updated using this alternate username.'), true);
                }
            }
            ...
            if ((($this->updates[$i] == "users_id")
                ...
                if ($update_done) {
                    Session::addMessageAfterRedirect(
                            __('User or group updated. The connected items have been moved in the same values.'), true);
                }
            }
            ...
            if (($this->updates[$i] == "states_id")
                ...
                if ($update_done) {
                    Session::addMessageAfterRedirect(
                            __('Status updated. The connected items have been updated using this status.'), true);
                }
            }
            ...
            if (($this->updates[$i] == "locations_id")
                ...
                if ($update_done) {
                    Session::addMessageAfterRedirect(
                            __('Location updated. The connected items have been moved in the same location.'), true);
                }
            }
        }
    }
...
//        echo "<tr class='headerRow'><th colspan='2'>Customer</th><th colspan='2'>Computer</th></tr>";
        ...
        echo "</td>";
//        echo "<td><b>" . sprintf(__('%1$s%2$s'), __('Name'), (isset($options['withtemplate']) && $options['withtemplate'] ? "*" : "")) . "</b></td>";
...
//        echo "<td>" . __('Product ID of the operating system') . " </td>";
        ...
        echo "<tr class='tab_bg_1'>";
//        echo "<td><b>" . __('Location') . "</b></td>";
        echo "<td><b>Postcode</b></td>";
        echo "<td>";
        Html::autocompletionTextField($this, 'contact');      
        echo "</td>";
        echo "<td><b>" . __('Model') . "</b></td>";
        echo "<td>";
...
//        echo "<td>Machine Type</td>";
        ...
        echo isset($_GET['id']) && $_GET['id'] != -1 ? '<a id="dialogBtn" style="cursor: pointer;cursor: hand;">Components</a>' : NULL;
        echo '<script>
            $("#dialog").dialog({
                autoOpen: false,
                modal: true,
                ...
                open: function(ev, ui){
                    $("#loading").show();
                    $("#myIframe").attr("src","/components/index.php?r=site/index&id='.$_GET['id'].'");
                }
            });
...
//        echo "<td>" .sprintf(__('%1$s%2$s'), __('Inventory number'), (isset($options['withtemplate']) && $options['withtemplate'] ? "*" : "")). "</td>";
        ...
        echo "<div style='padding-top:15px;'>" . __('Status')   ."</div>";
        echo "<div style='margin-top: 16px;'>" . __('Group')   ."</div>";
        echo "</td>";
...
//        echo "<td rowspan='$rowspan'><b>" . __('Comments') . "</b></td>";
//        echo "<td rowspan='$rowspan'>Remarks</td>";
        echo "<td rowspan='$rowspan'>System Config</td>";
